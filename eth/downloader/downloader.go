...
func New(
	checkpoint uint64, // 0
	stateDb ethdb.Database, // chainDB
	mux *event.TypeMux, // eth.eventMux
	chain BlockChain, // blockchain
	lightchain LightChain, // nil
	dropPeer peerDropFn, // Func
	success func(),	// Func
	) *Downloader {
	if lightchain == nil {
		lightchain = chain
	...
	dl := &Downloader{
		...
		// blockCacheMaxItems: 8192  blockCacheInitialItems: 2048
