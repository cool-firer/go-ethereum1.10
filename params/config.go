...
var NetworkNames = map[string]string{
	MainnetChainConfig.ChainID.String(): "mainnet", // 主网chainId: 1
	RopstenChainConfig.ChainID.String(): "ropsten",	// 3
	RinkebyChainConfig.ChainID.String(): "rinkeby",	// 4
	GoerliChainConfig.ChainID.String():  "goerli",	// 5
	SepoliaChainConfig.ChainID.String(): "sepolia",	// 11155111
}
