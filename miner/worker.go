...
// 构造封装任务
// 这个函数还没有填充pending tx, 是返回空的任务
// (也就是任务里包含pending tx)
// new阶段只有 { coinbase, timestamp }
...
// New阶段第一次: w.commit(work.copy(), nil, false, start)
//    New第二次: w.commit(work.copy(), w.fullTaskHook, true, start)
